 ...
 */
var modelModule = (function (core, seed) {
    "use strict";
 ...
 * @return {[type]} [description]
 */
var _init = (function (core, model, view, controller, seed) {
    /**
    ...
    return function (conf) {
        ...
        if (!controller.frequenceController.isDisabled(pdps)) {
            model.request(pdps, seed.get(pdps))
...
})(core, modelModule, viewModule, controllerModule, seed);
