...
(function (window, undefined) {
     ...
     */
    sinaadToolkit.throttle = sinaadToolkit.throttle || function (fn, delay, immediate, debounce) {
     ...
     * @return {function}    实际调用函数
     */
    sinaadToolkit.debounce = sinaadToolkit.debounce || function (fn, delay, immediate) {
