(function (core, view) {
    ...
    view.register('embed', function (element, width, height, content, config) {
        ...
        adContent = src ? core.ad.createHTML(type, src, width, height, link, content.origin_monitor, core.isFunction(tpl) ? tpl(0, type, src, width, height, link, content.monitor) : tpl) : ''; //广告内容， 如果没有src，则不渲染 
